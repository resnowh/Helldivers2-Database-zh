...
- 本次新增 `Predator Strain` 相关条目时，优先采用中文社区高一致性写法 `掠食变种 / 掠食追猎虫 / 掠食追踪虫`；由于暂未检到游戏内中文或官方中文公告，文中保留英文名并在终结族分章注明命名层级。
...
#### 吐酸泰坦（Bile Titan）补充 Anatomy 细化

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 6500 | 重甲 | 100% | - | 主体本身极硬，不适合拿中低档火力硬灌。 |
| 头部 | 1500 | 重甲 | 95% | 100% | 仍是最高价值直杀点，重穿反坦克命中收益最高。 |
| 上腹囊 | 750 | 无甲 I | 100% | 100% | 破坏后可明显削弱喷吐并稳定转伤主血。 |
| 下腹囊 | 750 | 无甲 I | 100% | 100% | 与上腹囊同理，适合补伤与压制吐酸能力。 |
| 前躯干外甲 | 1500 | 重甲 | 100% | 100% | 正面看似“能打”，但效率远不如头和腹囊。 |
| 暴露腹部内层肉体 | 4000 | 无甲 I | 70% | 100% | `2024-09-17` 后新增的独立腹部内层血池；外层被拆后可作为持续输出位。 |
| 臀部装甲 | 3500 | 重甲 | 100% | 100% | 可受伤，但属于低优先级输出区。 |

结论：

- `头部` 依然是最稳的反坦克处决口。
- `双腹囊 -> 暴露腹部内层` 提供了“无法稳定爆头时”的次优处理路径。
- 由于 `吐酸泰坦` 自 `2024-04-02` 起已不能被眩晕，实战更应依赖走位、掩体和高爆发反重武器。

#### 监视者（Overseer）

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 600 | 无甲 I | 0% | - | 纸面主血不高，但护盾会显著提高正面击杀门槛。 |
| 头部 | 150 | 中甲 | 0% | 100% | 命中即可高效击杀，但要求中穿或更高穿透。 |
| 胸甲 | 150 | 轻甲 | 0% | 20% | 只能少量转伤主血，不适合正面硬磨。 |

结论：

- 监视者的难点不是高生命，而是 `护盾遮挡 + 正面胸甲转伤低`。
- 因为 `头部` 为中甲 100% 转伤，`中穿精确点头` 仍是最高效率解。
- 若难以打头，就应优先走 `侧后绕盾` 或用 `爆炸 / 火焰 / 毒气` 绕开护盾节奏。

#### 崇高监视者（Elevated Overseer）

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 450 | 无甲 I | 0% | - | 主血比标准监视者更低，但空中机动显著提高命中难度。 |
| 头部 | 200 | 轻甲 | 0% | 100% | 比普通监视者更容易被中轻穿火力稳定爆头。 |
| 喷气背包 | 破裂即引爆 | 外部装甲板保护 | - | - | 背包被打爆会触发约 150 爆炸并直接杀死本体。 |

结论：

- 崇高监视者不是“更硬”，而是“更难稳稳打中”。
- `轻甲头部 + 100% 转伤` 让它在被控住、悬停或转向时非常容易被快速点杀。
- `喷气背包殉爆` 使其对持续压制和火焰尤其敏感，但近身收尾要防尸体后爆。

#### 刺魟（Stingray）

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 800 | 中甲 | 70% | - | 当前公开 Anatomy 只有主体主血池，没有可稳定利用的独立软弱点。 |

结论：

- 刺魟的核心并不是“找弱点”，而是 `抓减速悬停窗口把整机直接打掉`。
- `中甲 + 70% 耐久` 代表低穿、低耐久伤害武器会显著掉效率。
- 机炮、反器材步枪、火箭类武器之所以稳定，是因为它们能在短窗口内把整机血池迅速压空。

#### 观察者（Watcher）

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 600 | 无甲 I | 0% | - | 纸面主血不高，但会叫增援，优先级远高于其耐久表现。 |
| 核心主体 | 400 | 轻甲 | 0% | 100% | 发光核心就是稳定致命位，能穿轻甲就能快速处决。 |

结论：

- 观察者不是“难杀目标”，而是 `必须先杀的节奏目标`。
- `核心主体 400 / 轻甲 / 100% 转伤` 说明任何能稳定命中核心的中近距武器都足够高效。
- 其外形细长、移动飘忽，但并不存在复杂装甲谜题；关键是别让它把 `Warp Ship` 叫下来。

#### 新月监视者（Crescent Overseer）

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 600 | 无甲 I | 0% | - | 主血与普通监视者相同，但没有护盾，真正危险在远程压制。 |
| 头部 | 150 | 中甲 | 0% | 100% | 与普通监视者一样，仍是最高收益直杀点。 |
| 胸甲 | 150 | 轻甲 | 0% | 20% | 正面胸甲只会少量转伤，不适合硬磨。 |
| 胯部装甲 | 200 | 轻甲 | 0% | 20% | 也是低收益区。 |
| 四肢装甲 | 100 | 轻甲 | 0% | 20% | 打甲片本身收益低。 |
| 躯干 | 600 | 无甲 II | 0% | 100% | 一旦绕开正面甲片，躯干本体就是高效输出区。 |
| 右臂 | 300 | 无甲 II | 0% | 50% | 可补伤，也能通过拆臂降低近距离输出。 |
| 左臂 | 300 | 无甲 II | 0% | 50% | 与右臂类似，但击杀效率仍不如打头或打躯干。 |
| 腿部 | 主血共享 | 无甲 I | 0% | 70% | 可绕开上半身甲片补伤，但收益略低于直打软躯干。 |

结论：

- 新月监视者的本质是 `没有盾的炮兵版监视者`，并不是更硬，只是更会逼位。
- 它与普通监视者共用 `头部中甲 100% 转伤` 逻辑，因此 `中穿点头` 依然是最快处理法。
- 如果打不到头，就应优先切 `无甲 II 躯干`，而不是对着胸甲和胯甲浪费输出。
- 其背包不是弱点，这一点与 `崇高监视者` 不同，别误判成“打包必爆”。

#### 守门人（Gatekeeper）

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 2500 | 重甲 | 100% | - | 整体按重型构装体看待，轻火力正面磨血效率很差。 |
| 盾发生器 | 50 | 重甲 | 0% | 0% | 头顶“角”极脆，但本身重甲；打掉后可永久关闭驾驶舱护盾。 |
| 车体 | 1600 | 重甲 | 80% | 75% | 正面可打但很亏，更像“能磨，不该磨”。 |
| 后部弱点 | 800 | 无甲 II | 80% | 100% | 典型高收益击杀口，绕后时应优先打这里。 |
| 护盾 | 1300 | 轻甲 | 0% | 0% | 只是保护层，不会转伤主血。 |
| 驾驶舱 | 1200 | 重甲 | 80% | 75% | 与本体连接位一起构成正面可处理口，但很吃高穿甲。 |
| 驾驶舱弱点 | 800 | 无甲 II | 80% | 100% | 连接桩/裸露连接位是最稳定的正面高收益点。 |
| 手臂 | 1600 | 中甲 | 50% | 100% | 可拆，但主要价值是削弱火力，不是最快击杀路径。 |
| 腿/髋 | 800 | 中甲 | 50% | 100% | 对持续型中穿武器很友好，拆腿能稳定处决。 |
| 内部组件（破甲后） | 800 | 轻甲 | 50% | 100% | 后部装甲破开后可高效率收尾。 |

结论：

- 守门人的核心是 `先关盾，再打驾驶舱连接位 / 后部弱点 / 腿部`。
- `重甲外壳 + 无甲 II 驾驶舱弱点` 解释了为什么 EAT、RR 这种高爆发武器打连接位收益极高。
- 若队伍缺少单发反坦克，`机炮 / 重机枪` 走拆腿路线也成立，但需要更稳定的持续输出窗口。

#### 裁验者（Veracitor）

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 3000 | 中甲 | 100% | - | 比守门人更偏近战压迫，整体没有那么硬，但更容易贴脸。 |
| 头部 | 300 | 中甲 | 0% | 0% | 不是主弱点，打头本身并不直接转伤主血。 |
| 车体 | 1600 | 中甲 | 50% | 75% | 正面能打，但效率不如驾驶舱弱点与内部结构。 |
| 外壳甲板 | 400 | 中甲 | 50% | 50% | 属于过渡层，主要作用是遮挡内部。 |
| 内部组件 | 600 | 无甲 II | 50% | 100% | 破甲后是标准高收益区。 |
| 护盾 | 1300 | 轻甲 | 0% | 0% | 只负责保护驾驶舱，不会转伤主血。 |
| 驾驶舱 | 1600 | 中甲 | 50% | 100% | 可以作为直接击杀口，穿透要求低于守门人。 |
| 驾驶舱弱点 | 800 | 无甲 II | 50% | 100% | 高收益主弱点，最适合反器材步枪、机炮、反坦克武器。 |
| 肩部/上臂 | 800 | 轻甲 | 50% | 75% | 可拆并显著削弱贴脸压制。 |

结论：

- 裁验者是 `中甲版近战构装体`，不像守门人那样靠重甲和远程火力拖线。
- `驾驶舱弱点 / 内部组件 / 肩臂` 都能有效转伤，因此它比守门人更容易被持续中穿武器拆解。
- 当它开始冲锋时，`侧移拆腿或打驾驶舱连接位` 仍比正面硬灌主体稳定。

#### 入侵者（Obtruder）

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 400 | 无甲 I | 0% | - | 纸面很脆，真正威胁来自成群包围和死亡爆炸。 |
| 本体 | 400 | 无甲 II | 0% | 100% | 直接命中机体本身就能高效击杀。 |
| 眼部 | 300 | 无甲 I | 0% | 100% | 正面可快速点杀，但没有必要为此刻意追求精确爆点。 |
| 竖鳍 | 100 | 无甲 I | 0% | 100% | 任意高射速武器都能轻松拆掉，但单独打鳍不如直接清本体。 |
| 侧鳍 | 100 | 无甲 I | 0% | 100% | 与竖鳍同理，更像附带命中区而不是核心弱点。 |

结论：

- 入侵者本质上是 `会飞、会爆、但不叫增援的观察者杂兵版`。
- 因为 `主体无甲 II / 眼部无甲 I`，高射速主武器、连锁电弧和范围爆炸都能稳定清群。
- 它的危险不是单只强度，而是 `群体贴脸 + 死亡爆炸 + 地形包围`。

#### 肉瘤体（Fleshmob）

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 5000 | 无甲 I | 40% | - | 极高主血池，没有真正意义上的一击致命部位。 |
| 头脸块 | 400 | 无甲 I | 25% | 150% | 当前最关键弱点；高爆发武器打这里收益极高。 |
| 腹部块 | 400 | 无甲 I | 40% | 100% | 可稳定转伤，但效率明显低于头脸块。 |
| 手臂 | 200 | 无甲 I | 40% | 25% | 拆臂能显著降低拍击威胁，但并不是高效击杀口。 |
| 腿部 | 400 | 无甲 I | 40% | 100% | 可转伤主血，但拆腿不会减速，也不会阻止冲锋。 |

结论：

- 肉瘤体是 `纯血量与压迫型目标`，不是装甲谜题。
- `头脸块 150% 转伤` 解释了为什么某些高爆发武器能近似“秒杀”，而持续低爆发武器会显得刮痧。
- `拆臂降近战 / 不拆腿减速 / 无致命部位` 说明对它更适合高爆炸、高破片和高总 DPS 方案。

#### 利维坦（Leviathan）

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 15000 | 重甲 | 0% | - | 大体量空中战舰，正面硬灌非常吃资源。 |
| 炮塔 | 1500 | 重甲 | 85% | 0% | 优先拆炮塔能大幅降低致死性，但不直接转伤主血。 |
| 前段脊椎 | 7000 | 坦克 I | 0% | 100% | 高价值结构位，反坦克命中即可稳定压主血。 |
| 前鳍 | 5500 | 坦克 I | 0% | 100% | 破坏后可进一步暴露内部。 |
| 跃迁盘 | 3000 | 坦克 I | 0% | 100% | 底部高收益部位，但命中窗口受站位限制。 |
| 中前段脊椎 | 5500 | 坦克 I | 0% | 100% | 与其他脊椎段一样，属于反舰输出位。 |
| 中前段鳍 | 5000 | 坦克 I | 0% | 100% | 可作为稳定持续削血点。 |
| 中后段脊椎 | 5500 | 坦克 I | 0% | 100% | 同样是主血转伤结构。 |
| 中后段鳍 | 3900 | 坦克 I | 0% | 100% | 相比前段更容易被打掉。 |
| 后段脊椎 | 5000 | 坦克 I | 0% | 100% | 后半段命中窗口通常更安全。 |
| 后鳍 | 3000 | 坦克 I | 0% | 100% | 破坏后较容易看到内部。 |
| 尾部 | 3900 | 坦克 I | 0% | 100% | 尾部与鳍片破坏后可暴露内部。 |
| 内部结构 | 15000 | 重甲 | 0% | 100% | 鳍片/尾部破裂后出现，是高穿甲武器的理想输出位。 |

结论：

- 利维坦应按 `可拆炮塔的反舰目标` 处理，而不是普通飞行重单位。
- `先拆炮塔降威胁 -> 再打脊椎 / 鳍片 / 尾部 -> 露出内部后持续输出` 是最稳流程。
- 由于它自 `2025-10-23` 起改成光束主炮，烟雾能挡索敌但不能取消已锁定光束，这点要写进实战判断。

#### 运输飞船（Illuminate Overship）

| 部位 | 部位血量 | 装甲 | 耐久 | 转伤主生命 | 结论 |
| --- | --- | --- | --- | --- | --- |
| 主体 | 18001 | 坦克 VI | 100% | - | 自 `2026-03-17` 起已升级为超高装甲，不再是常规反甲目标。 |
| 发光港口 | 1500 | 坦克 VI | 100% | 100% | 仍是任务要求下的核心弱点，但必须先去盾。 |
| 护盾 | 10000 | 无甲 I | 0% | 0% | 只是保护层，不会转伤主血；会在 20 秒无伤后开始每秒回复 500。 |

结论：

- 运输飞船现在本质上是 `任务机制目标`，不是“带更多反坦克就能解决”的普通敌人。
- `先压护盾 -> 用行星防御炮打发光港口` 才是正解；常规重武器更多只是协助去盾。
- 护盾在击破 60 秒后会重新出现并开始回复，因此拖太久会把战斗重置回去。
...
| 掠食追猎虫 | Predator Hunter | 175 | 头 40；爪 60；腿 60；翼 20 | 无甲 I | `Predator Strain` 子派系单位；会隐形、会扑击，也会吐酸并可放出信息素引发虫潮。 |
...
| 掠食追踪虫 | Predator Stalker | 650 | 头 175；爪 200；腿 200；翼 125 | 无甲 II | `Predator Strain` 子派系单位；不会隐形，但会作为常规巡逻和虫潮编成自然出现。 |
| 尖啸虫 | Shrieker | 80 | 头 30；肢体 30；翼 20 | 无甲 I | 血量很低，但俯冲与坠尸伤害危险。 |
| 吐酸泰坦 | Bile Titan | 6500 | 头 1500；上腹囊 750；下腹囊 750；暴露腹部内层 4000 | 重甲 | 火焰承伤 1.7 倍；口部和腹囊仍是实战重点。 |
...
| 监视者 | Overseer | 600 | 头 150；胸甲 150（仅 20% 转伤主血） | 轻甲配护盾 | 有盾，实际击杀门槛高于纸面主血。 |
| 崇高监视者 | Elevated Overseer | 450 | 头 200；喷气背包可殉爆 | 中型 | 机动强，但主血低于普通监视者。 |
| 新月监视者 | Crescent Overseer | 600 | 头 150；胸甲 150（20% 转伤）；躯干 600（无甲 II，100% 转伤） | 中型 | 与普通监视者主血一致，但无盾，定位偏火力压制。 |
| 收割者 | Harvester | 3000 | 眼部、髋关节、上下盾发生器为关键弱点 | 重型机械；带护盾 | 自带可再生护盾；任一盾发生器被拆即可永久失去护盾能力。 |
| 肉瘤体 | Fleshmob | 5000 | 头脸块 400（150% 转伤）；腹部块 400；手臂 200；腿部 400 | 无甲高肉度 | 当前页面变更记录确认主血已从 6000 下调到 5000。 |
| 刺魟 | Stingray | 800 | 主体 800；中甲；耐久 70% | 飞行器 | 扫射前后速变化时最容易命中，当前无稳定独立软弱点公开。 |
| 利维坦 | Leviathan | 15000 | 炮塔 1500；前段脊椎 7000；跃迁盘 3000；尾部 3900；内部结构 15000 | 坦克级飞行战舰 | 当前文档中主血最高的光能者常规单位之一。 |
| 运输飞船 | Illuminate Overship | 18001 | 发光港口 1500；护盾 10000 | 坦克 VI | `2026-03-17` 后主船体与港口已升至坦克 VI，现更偏任务机制目标。 |
| 跃迁飞船 | Warp Ship | 3500 | 主船体/船壳 3500 | 坦克 I | 先破盾再打本体；本质上是投送与据点单位。 |
| 守门人 | Gatekeeper | 2500 | 盾发生器 50；后部弱点 800；驾驶舱弱点 800；腿/髋 800 | 重型构装体 | wiki.gg 页面仍在完善中，但主表已足够支持实战判断。 |
| 入侵者 | Obtruder | 400 | 本体 400；眼部 300；竖鳍/侧鳍 100 | 轻型飞行目标 | 观察者分支的攻击型变种，单体弱但常成群。 |
| 裁验者 | Veracitor | 3000 | 头 300；内部组件 600；驾驶舱弱点 800；肩部/上臂 800 | 重型构装体 | 近战型构装体，血量与收割者同级。 |
...
| 掠食追猎虫 | Predator Hunter | 轻甲 | 1 | 已补掠食变种战术 |
| 强袭虫 | Charger | 重甲 | 3 | 已确认 |
| 喷涌虫 | Bile Spewer | 中甲 | 3 | 已确认 |
| 追踪虫 | Stalker | 轻甲 | ? | 已确认 |
| 掠食追踪虫 | Predator Stalker | 轻甲 | 4 | 已补掠食变种战术 |
...
| 掠食追猎虫 | Predator Hunter | 头部、腿部、近身前摇 | 比普通追猎虫更该先杀；隐形、吐酸和信息素虫潮让它的节奏破坏力远超纸面血量。 |
| 掠食追踪虫 | Predator Stalker | 头部、下腹、连续硬直窗口 | 不会隐形，但不会像普通追踪虫那样脱战撤退，必须用停滞或连续火力硬压住。 |
...
- `Predator Strain` 是 `The Gloom` 相关的新终结族子派系；当前公开资料显示其固定构成为 `Predator Hunter` 与 `Predator Stalker`。
- `强袭虫（Charger）` 和 `吐酸泰坦（Bile Titan）` 属于终结族前线最值得保留重火力的目标。

### 掠食变种（Predator Strain）补录

说明：

- 该子派系于 `2025-02-12` 实装。
- 中文名当前未检到游戏内简中或官方简中公告，本文采用中文社区高一致性写法：
  - `Predator Strain = 掠食变种`
  - `Predator Hunter = 掠食追猎虫`
  - `Predator Stalker = 掠食追踪虫`

| 中文名 | 英文名 | 角色定位 | 已确认特征 | 实战建议 |
| --- | --- | --- | --- | --- |
| 掠食追猎虫 | Predator Hunter | 掠食变种轻型先锋 | 替换普通追猎虫；会隐形、扑击、吐酸，并可释放信息素引发虫潮 | 优先级高于普通追猎虫。毒气、燃烧和高停滞武器都能有效压制其隐形接近。 |
| 掠食追踪虫 | Predator Stalker | 掠食变种大型突击虫 | 替换部分武斗虫/虫巢守卫/追踪虫生态位；不会隐形，但会随巡逻、虫潮、巢穴和据点自然刷新 | 不要按普通追踪虫的“找巢后解题”思路处理；它更像会持续冲脸的重型近战虫群压力源。 |

| 中文名 | 英文名 | 关键部位 | 核心数值 | 实战结论 |
| --- | --- | --- | --- | --- |
| 掠食追猎虫 | Predator Hunter | 头 40；爪 60；腿 60；翼 20 | 主血 175；无甲 I；火焰承伤 0.7 倍 | 比普通追猎虫更硬一点，但最麻烦的是 `隐形 + 吐酸 + 虫潮触发`，应先杀。 |
| 掠食追踪虫 | Predator Stalker | 头 175；爪 200；腿 200；翼 125 | 主血 650；无甲 II；火焰承伤 1.25 倍 | 纸面反而低于普通追踪虫，但会大量自然出现且不撤退，更考验停滞和清近身能力。 |
...
| 掠食追猎虫 | Predator Hunter | 强化型追猎虫，能隐形、吐酸并触发虫潮 | 头部、腿部、隐形接近路线 | 这是掠食变种里最该先点掉的单位。它比普通追猎虫更会破坏队形，也更能把小失误放大成崩盘。 |
| 追踪虫 | Stalker | 隐形突袭精英，会快速再生 | 面部、巢穴方向 | 一旦发现就要立刻追压，不给其脱战回血的机会；同时尽快反查巢穴位置，否则会不断被偷袭。 |
| 掠食追踪虫 | Predator Stalker | 无法隐形的强化追踪虫，会常规编入巡逻和虫潮 | 头部、下腹、停滞窗口 | 它不像普通追踪虫那样打一下就拉开，而是会持续冲脸。高停滞霰弹、毒气、机枪类持续压制特别重要。 |

### 终结族阵营战术总结

- 轻型虫真正的杀伤力来自 `数量 + 贴脸 + 打断动作`，而不是单只数值。
- `吐酸虫`、`追猎虫`、`追踪虫` 往往比正面冲来的普通近战虫更该先杀。
- `掠食变种` 最大的变化不是单体血量，而是 `隐形单位常规化 + 大型突击虫自然刷新 + 虫潮节奏更快`。
...
| 观察者 | Watcher | 侦察/呼叫援军 | 已补 Anatomy 逻辑 |
| 监视者 | Overseer | 标准步兵指挥 | 已确认 |
| 崇高监视者 | Elevated Overseer | 悬浮步兵 | 已补 Anatomy 逻辑 |
| 新月监视者 | Crescent Overseer | 新增远程压制型 | 已补 Anatomy 逻辑 |
| 肉瘤体 | Fleshmob | 重型肉团冲锋 | 已补 Anatomy 逻辑 |
| 收割者 | Harvester | 三足重单位 | 已确认 |
| 刺魟 | Stingray | 空中支援机 | 已补战术 |
| 利维坦 | Leviathan | 大型新增单位 | 已补 Anatomy 逻辑 |
| 运输飞船 | Illuminate Overship | 重型飞行单位 | 已补 Anatomy 逻辑 |
...
| 中文名（已校对） | 英文名 | 备注 | 状态 |
| --- | --- | --- | --- |
| 守门人 | Gatekeeper | 中文资料未统一 | 已补 Anatomy 逻辑 |
| 入侵者 | Obtruder | 中文资料未统一 | 已补 Anatomy 逻辑 |
| 裁验者 | Veracitor | 中文资料未统一 | 已补 Anatomy 逻辑 |
...
| 观察者 | Watcher | 发光核心（主体 400，轻甲，100% 转伤） | 打碎中央发光核心即可；只打外侧“翼”不一定秒杀。 |
| 监视者 | Overseer | 中甲头部、胸甲低转伤、腿部绕盾位 | 中甲穿透、火焰、爆炸、硬控都很好用；其正面护盾不护侧后，也不挡爆炸、火焰、毒气。 |
| 崇高监视者 | Elevated Overseer | 轻甲头部、喷气背包殉爆 | 仍以中甲穿透、火焰、控制为优先。 |
| 收割者 | Harvester | 腿部连接处、腿部关节、眼部上/下方盾发生器、眼部 | 先破盾再打腿最稳；若打掉上下任一盾发生器，可永久关闭护盾能力。 |
| 肉瘤体 | Fleshmob | 无甲高主血；头脸块 150% 转伤；拆臂可降近战 | 不存在“神秘隐藏弱点”，重点是高伤害输出和避免被其直线冲锋撞翻。 |
...
| 中文名 | 英文名 | 核心特征 | 已确认弱点 | 实战建议 |
| --- | --- | --- | --- | --- |
| 监视者 | Overseer | 盾枪一体的标准精英步兵 | 中甲头部、胸甲仅 20% 转伤、腿部绕盾位 | 正面胸甲不值得硬磨；侧后与腿部绕盾位是最稳定的输出窗口。爆炸、火焰、硬控都很有效。 |
| 崇高监视者 | Elevated Overseer | 悬浮机动型，带枪与高爆投射 | 轻甲头部、喷气背包殉爆 | 比标准监视者更烦人，但被控住后反而更容易被快速处决。 |
| 新月监视者 | Crescent Overseer | 远程等离子炮，可直射也可曲射迫击 | 与标准监视者相同体型和装甲逻辑；无盾；头 150、躯干无甲 II 高转伤 | 类似“光能者版喷涌虫”。若放任其在远处叠加火力，会持续把玩家从掩体后逼出来。 |

### 新增大型单位补全

| 中文名 | 英文名 | 核心特征 | 已确认弱点 | 实战建议 |
| --- | --- | --- | --- | --- |
| 刺魟 | Stingray | 近距空中支援机，俯冲后沿蓝色轨迹扫射 | 无独立软弱点公开；整机中甲且耐久 70% | 平飞时极难击落，最佳输出窗口是其准备扫射时。中穿和高爆支援武器对它非常有效。 |
| 利维坦 | Leviathan | 大型浮空战舰，主炮和炸弹舱火力极重 | 炮塔可先拆；鳍片/尾部破坏后暴露内部 | 先拆主炮降低威胁，再用反坦克持续输出。烟雾可阻断其视线，但已锁定的激光不会立刻失效。 |
...
| 中文名 | 英文名 | 核心特征 | 已确认弱点 | 实战建议 |
| --- | --- | --- | --- | --- |
| 入侵者 | Obtruder | 观察者变种，不呼叫增援，成群喷射等离子弹 | 本体 400、眼部 300、死亡爆炸 | 单只威胁低，数量上来会迅速形成包围。高射速武器、连锁电弧与范围爆炸都很好处理。 |
| 守门人 | Gatekeeper | 远程型有人驾驶构装体，双星炮压制 | 顶部盾发生器、驾驶舱弱点、后部弱点、腿部 | 先破盾再打驾驶舱最稳；其长时间连发会慢速跟踪，横向持续移动比死蹲掩体更安全。 |
| 裁验者 | Veracitor | 近战型有人驾驶构装体，冲锋与拍击为主 | 驾驶舱弱点、内部组件、肩臂、腿部 | 类似光能者版浩克。别直线后退，侧移闪冲锋；拆腿、拆臂都能显著降低威胁。 |
...
- 继续扩充 `部位结构（Anatomy）` 细分数据，下一批优先补 `无票者`、`跃迁飞船`、`歼灭者坦克`、`巨型者`。
...
- [Helldivers Wiki - Predator Strain](https://helldivers.wiki.gg/wiki/Predator_Strain)
- [Helldivers Wiki - Predator Hunter](https://helldivers.wiki.gg/wiki/Predator_Hunter)
- [Helldivers Wiki - Predator Stalker](https://helldivers.wiki.gg/wiki/Predator_Stalker)
